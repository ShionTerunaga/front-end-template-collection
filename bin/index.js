...
const fastq = __nccwpck_require__(5033);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const utils = __nccwpck_require__(7463);
const partial_1 = __nccwpck_require__(9084);
class DeepFilter {
...
const entry_2 = __nccwpck_require__(7578);
class Provider {
    constructor(_settings) {
        this._settings = _settings;
...
const path = __nccwpck_require__(6928);
const scan = __nccwpck_require__(2489);
...
const DatePart = __nccwpck_require__(1766);
...
module.exports = {
  DatePart: __nccwpck_require__(1766),
  Meridiem: __nccwpck_require__(7173),
  Day: __nccwpck_require__(1065),
  Hours: __nccwpck_require__(472),
  Milliseconds: __nccwpck_require__(9965),
  Minutes: __nccwpck_require__(9430),
  Month: __nccwpck_require__(3877),
  Seconds: __nccwpck_require__(5642),
  Year: __nccwpck_require__(6830)
};
...
const color = __nccwpck_require__(7309);

const Prompt = __nccwpck_require__(9294);

const _require = __nccwpck_require__(318),
      erase = _require.erase,
      cursor = _require.cursor;

const _require2 = __nccwpck_require__(4835),
...
const MultiselectPrompt = __nccwpck_require__(3127);
...
const _require = __nccwpck_require__(4835),
      style = _require.style,
      clear = _require.clear;

const _require2 = __nccwpck_require__(318),
...
const _require3 = __nccwpck_require__(8591),
...
module.exports = {
  TextPrompt: __nccwpck_require__(4719),
  SelectPrompt: __nccwpck_require__(8316),
  TogglePrompt: __nccwpck_require__(2552),
  DatePrompt: __nccwpck_require__(5960),
  NumberPrompt: __nccwpck_require__(9145),
  MultiselectPrompt: __nccwpck_require__(3127),
  AutocompletePrompt: __nccwpck_require__(2112),
  AutocompleteMultiselectPrompt: __nccwpck_require__(8323),
  ConfirmPrompt: __nccwpck_require__(8170)
};
...
const prompts = __nccwpck_require__(9169);
...
const el = __nccwpck_require__(6486);
...
const strip = __nccwpck_require__(6737);
...
module.exports = {
  action: __nccwpck_require__(8901),
  clear: __nccwpck_require__(9606),
  style: __nccwpck_require__(326),
  strip: __nccwpck_require__(6737),
  figures: __nccwpck_require__(7754),
  lines: __nccwpck_require__(9568),
  wrap: __nccwpck_require__(7251),
  entriesToDisplay: __nccwpck_require__(1962)
};
...
const c = __nccwpck_require__(7309);

const figures = __nccwpck_require__(7754); // rendering user input.
...
const DatePart = __nccwpck_require__(1979);
...
module.exports = {
  DatePart: __nccwpck_require__(1979),
  Meridiem: __nccwpck_require__(6996),
  Day: __nccwpck_require__(4090),
  Hours: __nccwpck_require__(9799),
  Milliseconds: __nccwpck_require__(7836),
  Minutes: __nccwpck_require__(6453),
  Month: __nccwpck_require__(4562),
  Seconds: __nccwpck_require__(7817),
  Year: __nccwpck_require__(3199),
}
...
const color = __nccwpck_require__(7309);
const Prompt = __nccwpck_require__(9981);
const { erase, cursor } = __nccwpck_require__(318);
const { style, clear, figures, wrap, entriesToDisplay } = __nccwpck_require__(402);
...
const color = __nccwpck_require__(7309);
const { cursor } = __nccwpck_require__(318);
const MultiselectPrompt = __nccwpck_require__(5594);
const { clear, style, figures } = __nccwpck_require__(402);
/**
 * MultiselectPrompt Base Element
 * @param {Object} opts Options
 * @param {String} opts.message Message
...
const color = __nccwpck_require__(7309);
const Prompt = __nccwpck_require__(9981);
const { style, clear } = __nccwpck_require__(402);
const { erase, cursor } = __nccwpck_require__(318);
...
const color = __nccwpck_require__(7309);
const Prompt = __nccwpck_require__(9981);
const { style, clear, figures } = __nccwpck_require__(402);
const { erase, cursor } = __nccwpck_require__(318);
const { DatePart, Meridiem, Day, Hours, Milliseconds, Minutes, Month, Seconds, Year } = __nccwpck_require__(3148);
...
module.exports = {
  TextPrompt: __nccwpck_require__(2608),
  SelectPrompt: __nccwpck_require__(7216),
  TogglePrompt: __nccwpck_require__(3407),
  DatePrompt: __nccwpck_require__(663),
  NumberPrompt: __nccwpck_require__(1158),
  MultiselectPrompt: __nccwpck_require__(5594),
  AutocompletePrompt: __nccwpck_require__(2180),
  AutocompleteMultiselectPrompt: __nccwpck_require__(1838),
  ConfirmPrompt: __nccwpck_require__(2091)
};
...
const { cursor } = __nccwpck_require__(318);
const Prompt = __nccwpck_require__(9981);
const { clear, figures, style, wrap, entriesToDisplay } = __nccwpck_require__(402);
...
const color = __nccwpck_require__(7309);
const Prompt = __nccwpck_require__(9981);
const { cursor, erase } = __nccwpck_require__(318);
const { style, figures, clear, lines } = __nccwpck_require__(402);
...
const readline = __nccwpck_require__(3785);
const { action } = __nccwpck_require__(402);
const EventEmitter = __nccwpck_require__(4434);
const { beep, cursor } = __nccwpck_require__(318);
const color = __nccwpck_require__(7309);
...
const Prompt = __nccwpck_require__(9981);
const { erase, cursor } = __nccwpck_require__(318);
const { style, clear, lines, figures } = __nccwpck_require__(402);
...
const prompts = __nccwpck_require__(6226);
...
const $ = exports;
const el = __nccwpck_require__(575);
const noop = v => v;
...
const strip = __nccwpck_require__(8064);
const { erase, cursor } = __nccwpck_require__(318);
...
module.exports = {
  action: __nccwpck_require__(3346),
  clear: __nccwpck_require__(2283),
  style: __nccwpck_require__(4171),
  strip: __nccwpck_require__(8064),
  figures: __nccwpck_require__(6999),
  lines: __nccwpck_require__(5545),
  wrap: __nccwpck_require__(9696),
  entriesToDisplay: __nccwpck_require__(9913)
};
...
const c = __nccwpck_require__(7309);
const figures = __nccwpck_require__(6999);
...
const commander_1 = __nccwpck_require__(690);
exports.commanderCore = (function () {
    ...
    const program = new commander_1.Command("create-react-template")
        ...
        .option("--rf, --react-framework <reactFramework>", "framework to use (tanstack-router | next/app | next/pages)")
        .option("--vf, --vue-framework <vueFramework>", "vue framework to use (vue-router | nuxt)")
        .option("-c,--css <css>", "select css framework (tailwind | vanilla-extract | scoped-css)")
...
const option_1 = __nccwpck_require__(5315);
const is_1 = __nccwpck_require__(8538);
...
const prompts_1 = __importDefault(__nccwpck_require__(7193));
const core_static_1 = __nccwpck_require__(9645);
const result_1 = __nccwpck_require__(9439);
const command_core_1 = __nccwpck_require__(2497);
...
const core_static_1 = __nccwpck_require__(9645);
const react_static_1 = __nccwpck_require__(7005);
const is_1 = __nccwpck_require__(8538);
...
function isLibsArray(value) {
    return ((0, is_1.isArray)(value) && value.every((item) => react_static_1.libsArray.includes(item)));
}
...
exports.copy = copy;
const result_1 = __nccwpck_require__(9439);
const fast_glob_1 = __nccwpck_require__(197);
...
const picocolors_1 = __nccwpck_require__(1019);
const command_core_1 = __nccwpck_require__(2497);
const project_name_1 = __nccwpck_require__(4865);
const error_1 = __nccwpck_require__(4870);
const tech_stack_1 = __nccwpck_require__(2119);
const core_1 = __nccwpck_require__(6382);
const then_1 = __nccwpck_require__(9955);
...
const command_core_1 = __nccwpck_require__(2497);
const react_css_1 = __nccwpck_require__(7565);
const react_framework_1 = __nccwpck_require__(4774);
const result_1 = __nccwpck_require__(9439);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.librarySetting = exports.selectLibList = exports.libsArray = exports.reactCSSes = exports.frameworks = void 0;
/**
...
const vue_static_1 = __nccwpck_require__(7881);
function isVueFramework(value) {
    return (typeof value === "string" &&
        vue_static_1.vueFramework.includes(value));
}
function isVueCss(value) {
    return typeof value === "string" && vue_static_1.vueCSSes.includes(value);
}
...
const path_1 = __importDefault(__nccwpck_require__(6928));
const command_core_1 = __nccwpck_require__(2497);
const vue_css_1 = __nccwpck_require__(6089);
const vue_framework_1 = __nccwpck_require__(7258);
const option_1 = __nccwpck_require__(5315);
const result_1 = __nccwpck_require__(9439);
const found_file_1 = __nccwpck_require__(6795);
...
const { Argument } = __nccwpck_require__(4131);
const { Command } = __nccwpck_require__(627);
const { CommanderError, InvalidArgumentError } = __nccwpck_require__(7764);
const { Help } = __nccwpck_require__(4115);
const { Option } = __nccwpck_require__(5197);
...
const { InvalidArgumentError } = __nccwpck_require__(7764);
...
const { Argument, humanReadableArgName } = __nccwpck_require__(4131);
const { CommanderError } = __nccwpck_require__(7764);
const { Help, stripColor } = __nccwpck_require__(4115);
const { Option, DualOptions } = __nccwpck_require__(5197);
const { suggestSimilar } = __nccwpck_require__(9087);
...
const { humanReadableArgName } = __nccwpck_require__(4131);
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('["_http_agent","_http_client","_http_common","_http_incoming","_http_outgoing","_http_server","_stream_duplex","_stream_passthrough","_stream_readable","_stream_transform","_stream_wrap","_stream_writable","_tls_common","_tls_wrap","assert","assert/strict","async_hooks","buffer","child_process","cluster","console","constants","crypto","dgram","diagnostics_channel","dns","dns/promises","domain","events","fs","fs/promises","http","http2","https","inspector","inspector/promises","module","net","os","path","path/posix","path/win32","perf_hooks","process","punycode","querystring","readline","readline/promises","repl","stream","stream/consumers","stream/promises","stream/web","string_decoder","sys","timers","timers/promises","tls","trace_events","tty","url","util","util/types","v8","vm","wasi","worker_threads","zlib","node:sea","node:sqlite","node:test","node:test/reporters"]');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const main_1 = __nccwpck_require__(597);
(0, main_1.run)()
