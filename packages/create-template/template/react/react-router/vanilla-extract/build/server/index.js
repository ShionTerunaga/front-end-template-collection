...
function HomeView() {
    return /* @__PURE__ */ jsxs(Box, {
        ...
        children: [
            ...
            /* @__PURE__ */ jsx(Link, {
                to: '/server-loader',
                children: ja.app.home.toServerLoaderPotter,
            }),
            /* @__PURE__ */ jsx('br', {}),
            /* @__PURE__ */ jsx(Link, {
                to: '/client-loader',
                children: ja.app.home.toClientLoaderPotter,
            }),
            /* @__PURE__ */ jsx('br', {}),
            /* @__PURE__ */ jsx(Link, {
                to: '/server-action',
                children: ja.app.home.toServerActionPotter,
            }),
        ],
    })
}
...
const createHttpError = (function () {
    ...
    const createHttpError2 = ({ status, message }) => {
        return {
            type: 'httpError',
            status,
            message,
...
const createFetcherError = (function () {
    ...
    const createFetcher = ({ status, errorMessage }) => {
        return {
            type: 'fetcherError',
            status,
...
async function fetcher({ url, scheme, cache }) {
...
async function hasParseFetcher({ url, scheme, cache, parse }) {
    const { createOk } = resultUtility
...
function Card(props) {
    ...
    return /* @__PURE__ */ jsxs('div', {
        className: __default__.cardContainer,
        style: cardStyle,
        children: [
            /* @__PURE__ */ jsx('img', {
                src,
    ...
    return /* @__PURE__ */ jsxs('section', {
        children: [
            /* @__PURE__ */ jsx(Heading, {
                children: /* @__PURE__ */ jsx(FontCenter, { children: title }),
            }),
            /* @__PURE__ */ jsx(GridBox, {
                children: potters.map(({ id, image, name }) =>
                    /* @__PURE__ */ jsx(
                        Card,
                        {
                            src: image,
...
function CardLayout({ characters, title }) {
    if (characters.isErr) {
        return /* @__PURE__ */ jsxs(Box, {
            children: ['Error: ', characters.err.message],
        })
    }
    if (characters.value.isNone) {
        return /* @__PURE__ */ jsx(Box, { children: 'No characters found.' })
    }
    return /* @__PURE__ */ jsx(CardListView, {
        potters: characters.value.value,
        title,
    })
}
function ServerLoaderView({ characters }) {
...
function ClientLoaderView({ characters }) {
    return /* @__PURE__ */ jsx(CardLayout, {
        characters,
...
const clientLoader_default = UNSAFE_withComponentProps(
    function ClientLoaderRoute({ loaderData }) {
        const character = loaderData
...
function ServerActionView({ action: action2 }) {
    return /* @__PURE__ */ jsxs('main', {
        children: [
            /* @__PURE__ */ jsx(Heading, {
                children: ja.app.serverActionPotter.title,
            }),
            /* @__PURE__ */ jsx(Form, {
                method: 'post',
                children: /* @__PURE__ */ jsx(SubmitButton, {
                    title: ja.app.serverActionPotter.button,
                }),
            }),
            action2 &&
                /* @__PURE__ */ jsxs(Fragment, {
                    children: [
                        /* @__PURE__ */ jsx('div', {
                            children:
                                action2.isOk && action2.value.isSome
                                    ? /* @__PURE__ */ jsx('img', {
                                          alt: 'Random dog',
                                          width: 150,
                                          height: 150,
...
const serverManifest = {
    entry: {
        module: '/assets/entry.client-DSNVQjDe.js',
        imports: ['/assets/chunk-EPOLDU6W-CyFp4JB8.js'],
        css: [],
    },
    routes: {
        root: {
            ...
            module: '/assets/root-BV-oEQ8e.js',
            imports: ['/assets/chunk-EPOLDU6W-CyFp4JB8.js'],
        ...
        'routes/home': {
            ...
            module: '/assets/home-UsKjnYq_.js',
            imports: [
                '/assets/chunk-EPOLDU6W-CyFp4JB8.js',
                '/assets/ja-BCf0BCoW.js',
                '/assets/box-C4eT95C-.js',
            ],
        ...
        'routes/server-loader': {
            ...
            hasClientMiddleware: false,
            hasErrorBoundary: false,
            module: '/assets/server-loader-BTJ_fKm7.js',
            imports: [
                '/assets/chunk-EPOLDU6W-CyFp4JB8.js',
                '/assets/card-layout-CWmPtzoL.js',
                '/assets/ja-BCf0BCoW.js',
                '/assets/box-C4eT95C-.js',
            ],
            css: [
        ...
        'routes/client-loader': {
            ...
            hasClientMiddleware: false,
            hasErrorBoundary: false,
            module: '/assets/client-loader-CkAMXuyV.js',
            imports: [
                '/assets/chunk-EPOLDU6W-CyFp4JB8.js',
                '/assets/fetcher-scheme-CNYqZB-D.js',
                '/assets/card-layout-CWmPtzoL.js',
                '/assets/ja-BCf0BCoW.js',
                '/assets/box-C4eT95C-.js',
            ],
        ...
        'routes/server-action': {
            ...
            hasClientMiddleware: false,
            hasErrorBoundary: false,
            module: '/assets/server-action-CjjMtHu6.js',
            imports: [
                '/assets/chunk-EPOLDU6W-CyFp4JB8.js',
                '/assets/ja-BCf0BCoW.js',
                '/assets/fetcher-scheme-CNYqZB-D.js',
    ...
    url: '/assets/manifest-144c3dbc.js',
    version: '144c3dbc',
    sri: void 0,
}
