...
var Gr
function Aa() {
    return (Gr || ((Gr = 1), (Jt.exports = Oa())), Jt.exports)
}
var ql = Aa(),
    Gt = { exports: {} },
    z = {}
...
function ka() {
    ...
    ;((x.prototype.isReactComponent = {}),
        (x.prototype.setState = function (p, S) {
    ...
    ;((M.constructor = T), L(M, x.prototype), (M.isPureReactComponent = !0))
    var D = Array.isArray
    function N() {}
    ...
    function te(p, S, I, H, Y) {
        ...
        else if (((me = g(p)), typeof me == 'function'))
    ...
    return (
        ...
        (z.StrictMode = n),
        (z.Suspense = l),
        (z.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = m),
        ...
        (z.cloneElement = function (p, S, I) {
            ...
            if (J === 1) H.children = I
                ...
                for (var Q = Array(J), he = 0; he < J; he++)
                    Q[he] = arguments[he + 2]
                H.children = Q
            }
            return W(p.type, Y, H)
        ...
        (z.createElement = function (p, S, I) {
            ...
            if (Q === 1) Y.children = I
                ...
                for (var he = Array(Q), me = 0; me < Q; me++)
                    he[me] = arguments[me + 2]
                Y.children = he
            }
            if (p && p.defaultProps)
                for (H in ((Q = p.defaultProps), Q))
                    Y[H] === void 0 && (Y[H] = Q[H])
            return W(p, J, Y)
        }),
        ...
        (z.useActionState = function (p, S, I) {
            return m.H.useActionState(p, S, I)
        }),
        (z.useCallback = function (p, S) {
            return m.H.useCallback(p, S)
        }),
        ...
        (z.useDeferredValue = function (p, S) {
            return m.H.useDeferredValue(p, S)
        }),
        (z.useEffect = function (p, S) {
            return m.H.useEffect(p, S)
        }),
        ...
        (z.useImperativeHandle = function (p, S, I) {
            return m.H.useImperativeHandle(p, S, I)
        }),
        (z.useInsertionEffect = function (p, S) {
            return m.H.useInsertionEffect(p, S)
        }),
        (z.useLayoutEffect = function (p, S) {
            return m.H.useLayoutEffect(p, S)
        }),
        (z.useMemo = function (p, S) {
            return m.H.useMemo(p, S)
        }),
        (z.useOptimistic = function (p, S) {
            return m.H.useOptimistic(p, S)
        }),
        (z.useReducer = function (p, S, I) {
            return m.H.useReducer(p, S, I)
        }),
        (z.useRef = function (p) {
            return m.H.useRef(p)
        }),
        ...
        (z.useSyncExternalStore = function (p, S, I) {
            return m.H.useSyncExternalStore(p, S, I)
        }),
...
var Kr
function Na() {
    return (Kr || ((Kr = 1), (Gt.exports = ka())), Gt.exports)
}
var f = Na()
const Ia = _a(f),
    $a = Da({ __proto__: null, default: Ia }, [f])
var Mn = (e) => {
        throw TypeError(e)
    },
    Fa = (e, t, r) => t.has(e) || Mn('Cannot ' + r),
    Xt = (e, t, r) => (
    ...
    ja = (e, t, r) =>
        t.has(e)
            ? Mn('Cannot add the same private member more than once')
...
function Ua(e, t, r, n = {}) {
    ...
    function c() {
        ...
        let R = h(),
            x = R == null ? null : R - u
        ;((u = R), l && l({ action: s, location: L.location, delta: x }))
    }
    function y(R, x) {
        s = 'PUSH'
        let b = ut(L.location, R, x)
        u = h() + 1
        let T = Qr(b, u),
            M = L.createHref(b)
        try {
    ...
    let L = {
        ...
        listen(R) {
            ...
            return (
                a.addEventListener(qr, c),
                (l = R),
                () => {
                    ;(a.removeEventListener(qr, c), (l = null))
                }
            )
        },
        createHref(R) {
...
lt = new WeakMap()
var za = new Set(['lazy', 'caseSensitive', 'path', 'id', 'index', 'children'])
function Ba(e) {
    return za.has(e)
}
var Wa = new Set([
...
function ct(e, t, r = [], n = {}, a = !1) {
    return e.map((o, i) => {
        ...
        if (
            ...
            let u = { ...o, id: l }
            return ((n[l] = en(u, t(u))), u)
        } else {
            let u = { ...o, id: l, children: void 0 }
            return (
                (n[l] = en(u, t(u))),
                o.children && (u.children = ct(o.children, t, s, n, a)),
                u
            )
        }
    })
...
function _n(e, t = [], r = [], n = '', a = !1) {
    let o = (i, s, l = a, u) => {
        ...
        ;(i.children &&
            ...
            _n(i.children, t, y, c, l)),
            !(i.path == null && !i.index) &&
                t.push({ path: c, score: eo(c, i.index), routesMeta: y }))
    }
    return (
        e.forEach((i, s) => {
            if (i.path === '' || !i.path?.includes('?')) o(i, s)
            else for (let l of On(i.path)) o(i, s, !0, l)
        }),
        t
    )
}
...
function eo(e, t) {
    ...
    return (
        ...
        r
            .filter((a) => !tn(a))
            .reduce((a, o) => a + (Ga.test(o) ? Xa : o === '' ? qa : Qa), n)
    )
}
function to(e, t) {
    ...
    for (let s = 0; s < n.length; ++s) {
        ...
        ;(Object.assign(a, c.params),
            i.push({
                ...
                pathnameBase: lo(Le([o, c.pathnameBase])),
                route: y,
            }),
...
function At(e, t) {
    ...
    let [r, n] = An(e.path, e.caseSensitive, e.end),
        a = t.match(r)
    if (!a) return null
    let o = a[0],
        i = o.replace(/(.)\/+$/, '$1'),
        s = a.slice(1)
    return {
        params: n.reduce((u, { paramName: h, isOptional: c }, y) => {
            if (h === '*') {
                let E = s[y] || ''
...
function ao({ basename: e, pathname: t }) {
    return t === '/' ? e : Le([e, t])
}
var oo = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
    $t = (e) => oo.test(e)
function io(e, t = '/') {
    ...
    if (r)
        if ($t(r)) o = r
            ...
            r.startsWith('/') ? (o = rn(r.substring(1), '/')) : (o = rn(r, t))
        }
    else o = t
    return { pathname: o, search: so(n), hash: uo(a) }
}
function rn(e, t) {
    ...
    typeof e == 'string'
        ...
        : ((a = { ...e }),
          V(
              ...
              Kt('?', 'pathname', 'search', a),
          ),
          V(
              !a.pathname || !a.pathname.includes('#'),
              Kt('#', 'pathname', 'hash', a),
          ),
          V(!a.search || !a.search.includes('#'), Kt('#', 'search', 'hash', a)))
    let o = e === '' || a.pathname === '',
        i = o ? '/' : a.pathname,
        s
    if (i == null) s = r
...
var Le = (e) => e.join('/').replace(/\/\/+/g, '/'),
    lo = (e) => e.replace(/\/+$/, '').replace(/^\/*/, '/'),
    so = (e) => (!e || e === '?' ? '' : e.startsWith('?') ? e : '?' + e),
    uo = (e) => (!e || e === '#' ? '' : e.startsWith('#') ? e : '#' + e),
    co = class {
        constructor(e, t) {
...
function fo(e, t) {
    return new co(e, typeof t == 'number' ? { status: t } : t)
}
var ho = (e, t = 302) => {
        let r = t
        typeof r == 'number'
...
function po(e, t) {
    ...
    if (r.fetch.length > 0) {
        let n = e.fetch[Ie] ?? e.fetch,
            a = Ke(r.fetch, n, (...o) => {
                let [i, , s, l] = o
                return { href: s ?? '.', fetcherKey: i, ...an(e, l ?? {}) }
            })
        a && ((a[Ie] = n), (e.fetch = a))
    }
    return e
...
function Ke(e, t, r) {
    return e.length === 0
        ? null
        : async (...n) => {
              let a = await Nn(e, r(...n), () => t(...n), e.length - 1)
...
function an(e, t) {
    return {
        currentUrl: Pe(e.state.location),
...
var go = Object.getOwnPropertyNames(Object.prototype).sort().join('\0')
function wo(e) {
    ...
    return (
        t === Object.prototype ||
        t === null ||
        Object.getOwnPropertyNames(t).sort().join('\0') === go
    )
}
var In = ['POST', 'PUT', 'PATCH', 'DELETE'],
    Eo = new Set(In),
    Ro = ['GET', ...In],
    bo = new Set(Ro),
    ...
    Lo = (e) => ({ hasErrorBoundary: !!e.hasErrorBoundary }),
    $n = 'remix-router-transitions',
...
function Zl(e) {
    ...
    if (b == null && !e.patchRoutesOnNavigation) {
        let d = Se(404, { pathname: e.history.location.pathname }),
            { matches: v, route: w } = St(s)
        ;((D = !0), (b = v), (M = { [w.id]: d }))
    } else if (
        (b &&
            !e.hydrationData &&
            gt(b, s, e.history.location.pathname).active &&
            (b = null),
        b)
    )
        if (b.some((d) => d.route.lazy)) D = !1
        else if (!b.some((d) => yr(d.route))) D = !0
        else {
            ...
            if (v) {
                ...
                D = b.slice(0, w + 1).every((C) => !ar(C.route, d, v))
            } else D = b.every((w) => !ar(w.route, d, v))
        }
    else {
        ;((D = !1), (b = []))
        let d = gt(null, s, e.history.location.pathname)
        d.active && d.matches && ((T = !0), (b = d.matches))
    }
    let N,
        m = {
    ...
    function me() {
        if (
            ((y = e.history.listen(({ action: d, location: v, delta: w }) => {
                if (Q) {
                    ;(Q(), (Q = void 0))
                    return
                }
                ...
                if (C && w != null) {
                    ...
                    ;(e.history.go(w * -1),
                        vt(C, {
                            ...
                            reset() {
                                let O = new Map(m.blockers)
                                ;(O.set(C, at), pe({ blockers: O }))
                            },
                        }),
                        W?.resolve(),
                        (W = null))
        ...
        return (
            m.initialized || Fe('POP', m.location, { initialHydration: !0 }),
            N
        )
    }
    function zt() {
        ;(y && y(),
            ...
            g.clear(),
            U && U.abort(),
            m.fetchers.forEach((d, v) => Wt(v)),
            m.blockers.forEach((d, v) => Ur(v)))
    }
    function ma(d) {
    ...
    function pe(d, v = {}) {
        ;(d.matches &&
            (d.matches = d.matches.map((P) => {
                let O = i[P.route.id],
                    A = P.route
                return A.element !== O.element ||
                    A.errorElement !== O.errorElement ||
                    A.hydrateFallbackElement !== O.hydrateFallbackElement
                    ? { ...P, route: O }
                    : P
            })),
            (m = { ...m, ...d }))
        let w = [],
            C = []
        ;(m.fetchers.forEach((P, O) => {
            P.state === 'idle' && (Y.has(O) ? w.push(O) : C.push(O))
        }),
            Y.forEach((P) => {
                !m.fetchers.has(P) && !ee.has(P) && w.push(P)
            }),
            [...g].forEach((P) =>
                P(m, {
                    deletedFetchers: w,
            ...
            w.forEach((P) => Wt(P)),
            C.forEach((P) => m.fetchers.delete(P)))
    }
    function Je(d, v, { flushSync: w } = {}) {
        let C =
                m.actionData != null &&
        ...
        v.actionData
            ...
            : C
              ...
              : (P = null)
        let O = v.loaderData
                ? pn(m.loaderData, v.loaderData, v.matches || [], v.errors)
                : m.loaderData,
            A = m.blockers
        A.size > 0 && ((A = new Map(A)), A.forEach(($, F) => A.set(F, at)))
        let _ = ne ? !1 : Wr(d, v.matches || m.matches),
            k =
                G === !0 ||
                (m.navigation.formMethod != null &&
                    ve(m.navigation.formMethod) &&
        ...
        ;(l && ((s = l), (l = void 0)),
            ne ||
                ...
                (B === 'PUSH'
                    ...
                    : B === 'REPLACE' && e.history.replace(d, d.state)))
        let j
        if (B === 'POP') {
            let $ = Z.get(m.location.pathname)
            $ && $.has(d.pathname)
                ? (j = { currentLocation: m.location, nextLocation: d })
                : Z.has(d.pathname) &&
                  (j = { currentLocation: d, nextLocation: m.location })
        } else if (se) {
            let $ = Z.get(m.location.pathname)
            ;($
                ? $.add(d.pathname)
                : (($ = new Set([d.pathname])), Z.set(m.location.pathname, $)),
                (j = { currentLocation: m.location, nextLocation: d }))
        }
        ;(pe(
            {
            ...
            { viewTransitionOpts: j, flushSync: w === !0 },
        ),
            (B = 'POP'),
            (G = !1),
            (se = !1),
    ...
    async function kr(d, v) {
        if ((W?.resolve(), (W = null), typeof d == 'number')) {
            W || (W = gn())
            let re = W.promise
            return (e.history.go(d), re)
        }
        let w = nr(m.location, m.matches, u, d, v?.fromRouteId, v?.relative),
            { path: C, submission: P, error: O } = on(!1, w, v),
            A = m.location,
            _ = ut(m.location, C, v && v.state)
        _ = { ..._, ...e.history.encodeLocation(_) }
        let k = v && v.replace != null ? v.replace : void 0,
            j = 'PUSH'
        k === !0
            ? (j = 'REPLACE')
            : k === !1 ||
              (P != null &&
                  ...
                  (j = 'REPLACE'))
        let $ =
                v && 'preventScrollReset' in v
                    ? v.preventScrollReset === !0
                    : void 0,
            F = (v && v.flushSync) === !0,
            X = zr({ currentLocation: A, nextLocation: _, historyAction: j })
        if (X) {
            vt(X, {
                state: 'blocked',
                location: _,
    ...
    function pa() {
        ;(he || (he = gn()), Bt(), pe({ revalidation: 'loading' }))
        let d = he.promise
        return m.navigation.state === 'submitting'
            ? d
            : m.navigation.state === 'idle'
              ? (Fe(m.historyAction, m.location, {
                    startUninterruptedRevalidation: !0,
                }),
                d)
              : (Fe(B || m.historyAction, m.navigation.location, {
                    overrideNavigation: m.navigation,
                    enableViewTransition: se === !0,
                }),
                d)
    }
    async function Fe(d, v, w) {
        ;(U && U.abort(),
            (U = null),
            (B = d),
            (ne = (w && w.startUninterruptedRevalidation) === !0),
            La(m.location, m.matches),
            (G = (w && w.preventScrollReset) === !0),
            (se = (w && w.enableViewTransition) === !0))
        let C = l || s,
            P = w && w.overrideNavigation,
            O =
                w?.initialHydration && m.matches && m.matches.length > 0 && !T
                    ? m.matches
                    : Ae(C, v, u),
            A = (w && w.flushSync) === !0
        if (
            ...
            Je(v, { matches: O }, { flushSync: A })
            return
        }
        let _ = gt(O, C, v.pathname)
        if ((_.active && _.matches && (O = _.matches), !O)) {
            let { error: de, notFoundMatches: ae, route: oe } = Yt(v.pathname)
            Je(
                v,
                { matches: ae, loaderData: {}, errors: { [oe.id]: de } },
                { flushSync: A },
            )
            return
        }
        U = new AbortController()
        let k = Xe(e.history, v, U.signal, w && w.submission),
            j = e.getContext ? await e.getContext() : new Zr(),
            $
        if (w && w.pendingError)
            $ = [Ne(O).route.id, { type: 'error', error: w.pendingError }]
        ...
        F ||
            ((U = null),
            Je(v, { matches: X || O, ...yn($), loaderData: re, errors: ce }))
    }
    async function ya(d, v, w, C, P, O, A, _ = {}) {
        Bt()
        let k = Yo(v, w)
        if ((pe({ navigation: k }, { flushSync: _.flushSync === !0 }), O)) {
            let F = await wt(C, v.pathname, d.signal)
            if (F.type === 'aborted') return { shortCircuited: !0 }
            if (F.type === 'error') {
                if (F.partialMatches.length === 0) {
                    let { matches: re, route: ce } = St(s)
                    return {
                        matches: re,
                        pendingActionResult: [
                            ce.id,
                ...
                let X = Ne(F.partialMatches).route.id
                return {
                ...
                return {
                    matches: X,
                    pendingActionResult: [ce.id, { type: 'error', error: re }],
                }
            }
        }
        let j,
        ...
        if (!$.route.action && !$.route.lazy)
            ...
            let F = qe(o, i, d, C, $, A ? [] : n, P),
                X = await et(d, F, P, null)
            if (((j = X[$.route.id]), !j)) {
                for (let re of C)
                    if (X[re.route.id]) {
                        j = X[re.route.id]
        ...
        if (Be(j)) {
            ...
            return (
                ...
                await je(d, j, !0, { submission: w, replace: F }),
                { shortCircuited: !0 }
            )
        }
        if (we(j)) {
            ...
            return (
                ...
                { matches: C, pendingActionResult: [F.route.id, j, $.route.id] }
            )
        }
        return { matches: C, pendingActionResult: [$.route.id, j] }
    }
    async function va(d, v, w, C, P, O, A, _, k, j, $, F) {
        let X = O || Qt(v, A),
            re = A || _ || vn(X),
            ce = !ne && !j
        if (P) {
            ...
            let K = await wt(w, v.pathname, d.signal)
            if (K.type === 'aborted') return { shortCircuited: !0 }
            if (K.type === 'error') {
                if (K.partialMatches.length === 0) {
                    let { matches: Ge, route: ze } = St(s)
                    return {
                        matches: Ge,
                        loaderData: {},
                        errors: { [ze.id]: K.error },
                    }
                }
                let ye = Ne(K.partialMatches).route.id
                return {
        ...
        let de = l || s,
            { dsMatches: ae, revalidatingFetchers: oe } = ln(
                d,
                C,
                o,
                i,
            ...
            return (
                Je(
                    v,
                    {
                        matches: w,
                        loaderData: {},
                        errors: F && we(F[1]) ? { [F[0]]: F[1].error } : null,
                        ...yn(F),
        ...
        if (ce) {
            ...
            ;(oe.length > 0 && (K.fetchers = ga(oe)), pe(K, { flushSync: $ }))
        }
        oe.forEach((K) => {
        ...
        let { loaderResults: tt, fetcherResults: ke } = await Ir(ae, oe, d, C)
        if (d.signal.aborted) return { shortCircuited: !0 }
        ;(U && U.signal.removeEventListener('abort', He),
            oe.forEach((K) => ee.delete(K.key)))
        let Ce = xt(tt)
        if (Ce)
            return (
                await je(d, Ce.result, !0, { replace: k }),
                { shortCircuited: !0 }
            )
        if (((Ce = xt(ke)), Ce))
            return (
        ...
        let { loaderData: Vt, errors: rt } = mn(m, w, tt, F, oe, ke)
        j && m.errors && (rt = { ...m.errors, ...rt })
        let Ue = jr(),
            Et = Hr(be),
            Rt = Ue || Et || oe.length > 0
        return {
            matches: w,
            loaderData: Vt,
            errors: rt,
    ...
    function Nr(d) {
        if (d && !we(d[1])) return { [d[0]]: d[1].data }
        if (m.actionData)
    ...
    function ga(d) {
        return (
            d.forEach((v) => {
                let w = m.fetchers.get(v.key),
                    C = ot(void 0, w ? w.data : void 0)
                m.fetchers.set(v.key, C)
            }),
            new Map(m.fetchers)
        )
    }
    async function wa(d, v, w, C) {
        _e(d)
        let P = (C && C.flushSync) === !0,
            O = l || s,
            A = nr(m.location, m.matches, u, w, v, C?.relative),
            _ = Ae(O, A, u),
            k = gt(_, O, A)
        if ((k.active && k.matches && (_ = k.matches), !_)) {
            De(d, v, Se(404, { pathname: A }), { flushSync: P })
            return
        }
        let { path: j, submission: $, error: F } = on(!0, A, C)
        if (F) {
            De(d, v, F, { flushSync: P })
            return
        }
        let X = e.getContext ? await e.getContext() : new Zr(),
            re = (C && C.preventScrollReset) === !0
        if ($ && ve($.formMethod)) {
            await Ea(d, v, j, _, X, k.active, P, re, $)
            return
        }
        ;(I.set(d, { routeId: v, path: j }),
            await Ra(d, v, j, _, X, k.active, P, re, $))
    }
    async function Ea(d, v, w, C, P, O, A, _, k) {
        ;(Bt(), I.delete(d))
        let j = m.fetchers.get(d)
        Te(d, Vo(k, j), { flushSync: A })
        let $ = new AbortController(),
            F = Xe(e.history, w, $.signal, k)
        if (O) {
            let le = await wt(C, new URL(F.url).pathname, F.signal, d)
            if (le.type === 'aborted') return
            if (le.type === 'error') {
                De(d, v, le.error, { flushSync: A })
                return
            } else if (le.matches) C = le.matches
            else {
                De(d, v, Se(404, { pathname: w }), { flushSync: A })
                return
            }
        }
        let X = Tt(C, w)
        if (!X.route.action && !X.route.lazy) {
            let le = Se(405, { method: k.formMethod, pathname: w, routeId: v })
            De(d, v, le, { flushSync: A })
            return
        }
        ee.set(d, $)
        let re = fe,
            ce = qe(o, i, F, C, X, n, P),
            de = await et(F, ce, P, d),
            ae = de[X.route.id]
        if (!ae) {
            for (let le of ce)
                if (de[le.route.id]) {
        ...
        let oe = m.navigation.location || m.location,
            ...
            ke =
                m.navigation.state !== 'idle'
                    ? Ae(tt, m.navigation.location, u)
                    : m.matches
        V(ke, "Didn't find any matches after fetcher action")
        let Ce = ++fe
        p.set(d, Ce)
        let Vt = ot(k, ae.data)
        m.fetchers.set(d, Vt)
        let { dsMatches: rt, revalidatingFetchers: Ue } = ln(
            He,
            P,
            o,
            i,
        ...
        ;(Ue.filter((le) => le.key !== d).forEach((le) => {
            let bt = le.key,
                Vr = m.fetchers.get(bt),
                Ta = ot(void 0, Vr ? Vr.data : void 0)
            ;(m.fetchers.set(bt, Ta),
                _e(bt),
                le.controller && ee.set(bt, le.controller))
        }),
            pe({ fetchers: new Map(m.fetchers) }))
        let Et = () => Ue.forEach((le) => _e(le.key))
        $.signal.addEventListener('abort', Et)
        let { loaderResults: Rt, fetcherResults: K } = await Ir(rt, Ue, He, P)
        if ($.signal.aborted) return
        if (
            ($.signal.removeEventListener('abort', Et),
            p.delete(d),
            ee.delete(d),
        ...
        if (((ye = xt(K)), ye))
            return (
                S.add(ye.key),
                je(He, ye.result, !1, { preventScrollReset: _ })
            )
        let { loaderData: Ge, errors: ze } = mn(m, ke, Rt, void 0, Ue, K)
        ;(Hr(Ce),
            m.navigation.state === 'loading' && Ce > be
                ? (V(B, 'Expected pending action'),
                  U && U.abort(),
                  Je(m.navigation.location, {
                      matches: ke,
                      loaderData: Ge,
                      errors: ze,
                ...
                : (pe({
                      errors: ze,
                      loaderData: pn(m.loaderData, Ge, ke, ze),
                      fetchers: new Map(m.fetchers),
                  }),
                  (te = !1)))
    }
    async function Ra(d, v, w, C, P, O, A, _, k) {
        let j = m.fetchers.get(d)
        Te(d, ot(k, j ? j.data : void 0), { flushSync: A })
        let $ = new AbortController(),
            F = Xe(e.history, w, $.signal)
        if (O) {
            let oe = await wt(C, new URL(F.url).pathname, F.signal, d)
            if (oe.type === 'aborted') return
            if (oe.type === 'error') {
                De(d, v, oe.error, { flushSync: A })
                return
        ...
        let re = fe,
            ce = qe(o, i, F, C, X, n, P),
            ae = (await et(F, ce, P, d))[X.route.id]
        if ((ee.get(d) === $ && ee.delete(d), !F.signal.aborted)) {
            if (Y.has(d)) {
                Te(d, Oe(void 0))
                return
            }
            if (Be(ae))
                if (be > re) {
                    ...
                    ;(S.add(d), await je(F, ae, !1, { preventScrollReset: _ }))
                    return
                }
            if (we(ae)) {
                De(d, v, ae.error)
    ...
    async function je(
        ...
        ;(V(_, 'Expected a Location header on the redirect Response'),
            (_ = fn(_, new URL(d.url), u)))
        let k = ut(m.location, _, { _isRedirect: !0 })
        if (r) {
            let ce = !1
            if (v.response.headers.has('X-Remix-Reload-Document')) ce = !0
            else if ($t(_)) {
                const de = Tn(_, !0)
                ce =
                    de.origin !== t.location.origin ||
                    Ee(de.pathname, u) == null
            }
            if (ce) {
                A ? t.location.replace(_) : t.location.assign(_)
                return
            }
        }
        U = null
        let j =
                A === !0 || v.response.headers.has('X-Remix-Replace')
                    ? 'REPLACE'
                    : 'PUSH',
            { formMethod: $, formAction: F, formEncType: X } = m.navigation
        !C && !P && $ && F && X && (C = vn(m.navigation))
        let re = C || P
        if (xo.has(v.response.status) && re && ve(re.formMethod))
            await Fe(j, k, {
                submission: { ...re, formAction: _ },
                preventScrollReset: O || G,
                enableViewTransition: w ? se : void 0,
            })
        else {
            let ce = Qt(k, C)
            await Fe(j, k, {
    ...
    async function et(d, v, w, C) {
        let P,
            O = {}
        try {
            P = await Ao(h, d, v, C, w, !1)
        } catch (A) {
            return (
                v
                    .filter((_) => _.shouldLoad)
                    .forEach((_) => {
                        O[_.route.id] = { type: 'error', error: A }
                    }),
                O
            )
        }
        if (d.signal.aborted) return O
        for (let [A, _] of Object.entries(P))
            if (Bo(_)) {
                let k = _.result
                O[A] = { type: 'redirect', response: $o(k, d, A, v, u) }
            } else O[A] = await Io(_)
        return O
    }
    async function Ir(d, v, w, C) {
        let P = et(w, d, C, null),
            O = Promise.all(
                v.map(async (k) => {
                    if (k.matches && k.match && k.request && k.controller) {
                        let $ = (await et(k.request, k.matches, C, k.key))[
                            k.match.route.id
                        ]
                        return { [k.key]: $ }
                    } else
                        return Promise.resolve({
                            [k.key]: {
                                type: 'error',
                                error: Se(404, { pathname: k.path }),
                            },
                        })
                }),
            ),
            A = await P,
            _ = (await O).reduce((k, j) => Object.assign(k, j), {})
        return { loaderResults: A, fetcherResults: _ }
    }
    function Bt() {
        ;((te = !0),
            I.forEach((d, v) => {
                ;(ee.has(v) && ue.add(v), _e(v))
            }))
    }
    function Te(d, v, w = {}) {
        ;(m.fetchers.set(d, v),
    ...
    function De(d, v, w, C = {}) {
        let P = Ne(m.matches, v)
        ;(Wt(d),
            pe(
                { errors: { [P.route.id]: w }, fetchers: new Map(m.fetchers) },
    ...
    function ba(d, v) {
        ;(_e(d, v?.reason), Te(d, Oe(null)))
    }
    function Wt(d) {
        let v = m.fetchers.get(d)
        ;(ee.has(d) && !(v && v.state === 'loading' && p.has(d)) && _e(d),
            I.delete(d),
            p.delete(d),
            S.delete(d),
            Y.delete(d),
    ...
    function Sa(d) {
        let v = (H.get(d) || 0) - 1
        ;(v <= 0 ? (H.delete(d), Y.add(d)) : H.set(d, v),
            pe({ fetchers: new Map(m.fetchers) }))
    }
    function _e(d, v) {
        let w = ee.get(d)
        w && (w.abort(v), ee.delete(d))
    }
    function Fr(d) {
        for (let v of d) {
            let w = $r(v),
    ...
    function jr() {
        let d = [],
            v = !1
        for (let w of S) {
            let C = m.fetchers.get(w)
            ;(V(C, `Expected fetcher: ${w}`),
                C.state === 'loading' && (S.delete(w), d.push(w), (v = !0)))
        }
        return (Fr(d), v)
    }
    function Hr(d) {
        ...
        for (let [w, C] of p)
            if (C < d) {
                let P = m.fetchers.get(w)
                ;(V(P, `Expected fetcher: ${w}`),
                    P.state === 'loading' && (_e(w), p.delete(w), v.push(w)))
            }
        return (Fr(v), v.length > 0)
    }
    function xa(d, v) {
        let w = m.blockers.get(d) || at
        return (J.get(d) !== v && J.set(d, v), w)
    }
    function Ur(d) {
        ;(m.blockers.delete(d), J.delete(d))
    }
    function vt(d, v) {
        let w = m.blockers.get(d) || at
        V(
        ...
        ;(C.set(d, v), pe({ blockers: C }))
    }
    function zr({ currentLocation: d, nextLocation: v, historyAction: w }) {
        if (J.size === 0) return
        ...
        if (
            ...
            O({ currentLocation: d, nextLocation: v, historyAction: w })
        )
            return P
    }
    function Yt(d) {
        let v = Se(404, { pathname: d }),
            w = l || s,
            { matches: C, route: P } = St(w)
        return { notFoundMatches: C, route: P, error: v }
    }
    function Ca(d, v, w) {
        if (((E = d), (R = v), (L = w || null), !x && m.navigation === qt)) {
            x = !0
            let C = Wr(m.location, m.matches)
        ...
        if (e.patchRoutesOnNavigation)
            if (d) {
                if (Object.keys(d[0].params).length > 0)
                    return { active: !0, matches: st(v, w, u, !0) }
            } else return { active: !0, matches: st(v, w, u, !0) || [] }
        return { active: !1, matches: null }
    }
    async function wt(d, v, w, C) {
        ...
        for (;;) {
            ...
            if (k) {
                ...
                if (
                    ((j = st(A, v, u, !0)),
                    !(j && P.length < j.length && Yr(P, j.slice(0, P.length))))
                )
                    return { type: 'success', matches: k }
            }
            if ((j || (j = st(A, v, u, !0)), !j || Yr(P, j)))
    ...
    function Yr(d, v) {
        return (
            d.length === v.length &&
            d.every((w, C) => w.route.id === v[C].route.id)
        )
    }
    function Pa(d) {
        ;((i = {}), (l = ct(d, o, void 0, i)))
...
function nr(e, t, r, n, a, o) {
    ...
    let l = pr(n || '.', mr(i), Ee(e.pathname, r) || e.pathname, o === 'path')
    if (
    ...
    return (
        r !== '/' && (l.pathname = ao({ basename: r, pathname: l.pathname })),
        Pe(l)
    )
}
function on(e, t, r) {
    if (!r || !Po(r)) return { path: t }
    if (r.formMethod && !Wo(r.formMethod))
...
`,
    ...
    let s, l
    if (r.formData) ((s = ir(r.formData)), (l = r.formData))
    else if (r.body instanceof FormData) ((s = ir(r.body)), (l = r.body))
    else if (r.body instanceof URLSearchParams) ((s = r.body), (l = hn(s)))
    else if (r.body == null) ((s = new URLSearchParams()), (l = new FormData()))
    else
        try {
            ;((s = new URLSearchParams(r.body)), (l = hn(s)))
        } catch {
            return n()
        }
    let u = {
    ...
    let h = $e(t)
    return (
        e && h.search && gr(h.search) && s.append('index', ''),
        (h.search = `?${s}`),
        { path: Pe(h), submission: u }
    )
}
function ln(e, t, r, n, a, o, i, s, l, u, h, c, y, g, E, L, R, x, b, T) {
    let M = T ? (we(T[1]) ? T[1].error : T[1].data) : void 0,
        D = a.createURL(o.location),
        N = a.createURL(l),
        m
    if (h && o.errors) {
        let q = Object.keys(o.errors)[0]
        m = i.findIndex((ne) => ne.route.id === q)
    } else if (T && we(T[1])) {
        let q = T[0]
        m = i.findIndex((ne) => ne.route.id === q) - 1
    }
    let B = T ? T[1].statusCode : void 0,
        W = B && B >= 400,
        G = {
            currentUrl: D,
            ...
            if (
                (m != null && ne > m
                    ...
                    : te.lazy
                      ...
                      : yr(te)
                        ? h
                            ? (ue = ar(te, o.loaderData, o.errors))
                            : Mo(o.loaderData, o.matches[ne], q) && (ue = !0)
                        : (ue = !1),
                ue !== null)
            )
                return or(r, n, e, U, q, u, t, ue)
            let ee = W
                    ? !1
                    : c ||
                      D.pathname + D.search === N.pathname + N.search ||
                      D.search !== N.search ||
                      To(o.matches[ne], q),
                fe = { ...G, defaultShouldRevalidate: ee },
                be = kt(q, fe)
            return or(r, n, e, U, q, u, t, be, fe)
        }),
        Z = []
    return (
        E.forEach((q, ne) => {
            if (h || !i.some((I) => I.route.id === q.routeId) || g.has(ne))
                return
            ...
            let fe = Tt(ee, q.path),
                ...
                S = null
            if (y.has(ne)) (y.delete(ne), (S = qe(r, n, p, ee, fe, u, t)))
            else if (ue) c && (S = qe(r, n, p, ee, fe, u, t))
            else {
                let I = { ...G, defaultShouldRevalidate: W ? !1 : c }
                kt(fe, I) && (S = qe(r, n, p, ee, fe, u, t, I))
            }
            S &&
                Z.push({
                    key: ne,
...
function sn(e, t, r, n, a, o) {
    ...
    if (o && l.length > 0)
        for (let u = 0; u < l.length; u++) {
            let { existingRoute: h, newRoute: c } = l[u],
                y = h,
                [g] = ct([c], a, [], {}, !0)
            Object.assign(y, {
        ...
        : e.index === t.index &&
          ...
          ? (!e.children || e.children.length === 0) &&
            (!t.children || t.children.length === 0)
              ? !0
              : e.children.every((r, n) => t.children?.some((a) => jn(r, a)))
          : !1
}
var un = new WeakMap(),
    Hn = ({ key: e, route: t, manifest: r, mapRouteProperties: n }) => {
        let a = r[t.id]
        if (
        ...
        let l = (async () => {
            ...
            if (u)
                ...
                let y = await o()
                y != null &&
                    (Object.assign(a, { [e]: y }), Object.assign(a, n(a)))
            }
            typeof a.lazy == 'object' &&
                ((a.lazy[e] = void 0),
                Object.values(a.lazy).every((y) => y === void 0) &&
                    (a.lazy = void 0))
        })()
        return ((i[e] = l), l)
    },
...
function Do(e, t, r, n, a) {
    ...
    for (let h of i) {
        ...
        let c = Hn({ key: h, route: e, manifest: r, mapRouteProperties: n })
        c && (s.push(c), h === t && (l = c))
    }
...
async function Oo(e, t, r, n, a) {
    let {
        ...
        h = o.flatMap((y) =>
            y.route.middleware
                ? y.route.middleware.map((g) => [y.route.id, g])
                : [],
        )
    return await zn(
...
async function zn(e, t, r, n, a, o, i = 0) {
    let { request: s } = e
    if (s.signal.aborted)
        throw (
            s.signal.reason ??
            new Error(`Request aborted: ${s.method} ${s.url}`)
        )
    let l = t[i]
    if (!l) return await r()
    let [u, h] = l,
        ...
        y = async () => {
            ...
            try {
                return (
                    (c = { value: await zn(e, t, r, n, a, o, i + 1) }),
                    c.value
                )
            } catch (g) {
...
function Bn(e, t, r, n, a) {
    let o = Hn({
        ...
        i = Do(n.route, ve(r.method) ? 'action' : 'loader', t, e, a)
    return {
        middleware: o,
...
function or(e, t, r, n, a, o, i, s, l = null) {
    let u = !1,
        h = Bn(e, t, r, a, o)
    return {
        ...a,
        ...
        shouldCallHandler(c) {
            return (
                ...
                l
                    ? typeof c == 'boolean'
                        ? kt(a, { ...l, defaultShouldRevalidate: c })
                        : kt(a, l)
                    : s
            )
        },
        resolve(c) {
            let { lazy: y, loader: g, middleware: E } = a.route,
                L = u || s || (c && !ve(r.method) && (y || g)),
                R = E && E.length > 0 && !g && !y
            return L && (ve(r.method) || !R)
                ? ko({
                      request: r,
                      unstable_pattern: n,
                      match: a,
    ...
    try {
        ...
        if (n || a)
            if (y) {
                ...
                if (g) [s] = await Promise.all([c(g), a])
                else if (h === 'action') {
                    let E = new URL(e.url),
...
function $o(e, t, r, n, a) {
    ...
    if (
        ...
        ;((o = nr(new URL(t.url), i, a, o)), e.headers.set('Location', o))
    }
    return e
}
function fn(e, t, r) {
...
function Fo(e, t, r, n = !1, a = !1) {
    let o = {},
        i = null,
        s,
        l = !1,
        u = {},
        h = r && we(r[1]) ? r[1].error : void 0
    return (
        e.forEach((c) => {
            ...
            if (
                ...
                ;(n || (o[y] = Fn),
                    l || ((l = !0), (s = We(g.error) ? g.error.status : 500)),
...
function mn(e, t, r, n, a, o) {
    let { loaderData: i, errors: s } = Fo(t, r, n)
    return (
        a
            .filter((l) => !l.matches || l.matches.some((u) => u.shouldLoad))
            .forEach((l) => {
                let { key: u, match: h, controller: c } = l
                if (c && c.signal.aborted) return
                let y = o[u]
                if (
                    (V(y, 'Did not find corresponding fetcher result'), we(y))
                ) {
                    let g = Ne(e.matches, h?.route.id)
                    ;((s && s[g.route.id]) ||
                        (s = { ...s, [g.route.id]: y.error }),
                        e.fetchers.delete(u))
                } else if (Be(y))
...
function Uo(e) {
    return (
        e != null &&
        typeof e == 'object' &&
        Object.entries(e).every(([t, r]) => typeof t == 'string' && zo(r))
    )
}
function zo(e) {
    return (
...
function Bo(e) {
    return vr(e.result) && So.has(e.result.status)
}
function we(e) {
    return e.type === 'error'
}
...
function Tt(e, t) {
    ...
    if (e[e.length - 1].route.index && gr(r || '')) return e[e.length - 1]
    let n = kn(e)
    return n[n.length - 1]
}
function vn(e) {
...
function Jo(e, t) {
    try {
        let r = e.sessionStorage.getItem($n)
        if (r) {
            let n = JSON.parse(r)
...
function Go(e, t) {
    if (t.size > 0) {
        ...
        try {
            e.sessionStorage.setItem($n, JSON.stringify(r))
        } catch (n) {
            ie(
                !1,
...
var Ve = f.createContext(null)
Ve.displayName = 'DataRouter'
var Qe = f.createContext(null)
Qe.displayName = 'DataRouterState'
var Xo = f.createContext(!1)
function Ko() {
    return f.useContext(Xo)
}
var wr = f.createContext({ isTransitioning: !1 })
wr.displayName = 'ViewTransition'
var Yn = f.createContext(new Map())
Yn.displayName = 'Fetchers'
var qo = f.createContext(null)
qo.displayName = 'Await'
var Re = f.createContext(null)
Re.displayName = 'Navigation'
var Ft = f.createContext(null)
Ft.displayName = 'Location'
var xe = f.createContext({ outlet: null, matches: [], isDataRoute: !1 })
xe.displayName = 'Route'
var Er = f.createContext(null)
...
function Qo(e, { relative: t } = {}) {
    ...
    let { basename: r, navigator: n } = f.useContext(Re),
        { hash: a, pathname: o, search: i } = mt(e, { relative: t }),
        s = o
    return (
        r !== '/' && (s = o === '/' ? r : Le([r, o])),
...
function Jn(e) {
    f.useContext(Re).static || f.useLayoutEffect(e)
}
function Zo() {
    let { isDataRoute: e } = f.useContext(xe)
    return e ? hi() : ei()
}
function ei() {
    V(
    ...
    let e = f.useContext(Ve),
        { basename: t, navigator: r } = f.useContext(Re),
        { matches: n } = f.useContext(xe),
        { pathname: a } = Me(),
        o = JSON.stringify(mr(n)),
        i = f.useRef(!1)
    return (
        Jn(() => {
            i.current = !0
        ...
        f.useCallback(
            (l, u = {}) => {
                if ((ie(i.current, Vn), !i.current)) return
                if (typeof l == 'number') {
                    r.go(l)
                    return
                }
                let h = pr(l, JSON.parse(o), a, u.relative === 'path')
                ;(e == null &&
                    t !== '/' &&
                    (h.pathname = h.pathname === '/' ? t : Le([t, h.pathname])),
...
var ti = f.createContext(null)
function ri(e) {
    let t = f.useContext(xe).outlet
    return f.useMemo(
        () => t && f.createElement(ti.Provider, { value: e }, t),
        [t, e],
    )
}
function Rr() {
    let { matches: e } = f.useContext(xe),
        t = e[e.length - 1]
    return t ? t.params : {}
}
function mt(e, { relative: t } = {}) {
    let { matches: r } = f.useContext(xe),
        { pathname: n } = Me(),
        a = JSON.stringify(mr(r))
    return f.useMemo(() => pr(e, JSON.parse(a), n, t === 'path'), [e, a, n, t])
}
function ni(e, t, r, n, a) {
    ...
    let { navigator: o } = f.useContext(Re),
        { matches: i } = f.useContext(xe),
        s = i[i.length - 1],
        l = s ? s.params : {},
        u = s ? s.pathname : '/',
        h = s ? s.pathnameBase : '/',
...
var oi = f.createElement(ai, null),
    ii = class extends f.Component {
        constructor(e) {
            ;(super(e),
                (this.state = {
                    location: e.location,
...
function li({ routeContext: e, match: t, children: r }) {
    let n = f.useContext(Ve)
    return (
        n &&
            n.static &&
            n.staticContext &&
        ...
        f.createElement(xe.Provider, { value: e }, r)
    )
}
function si(e, t = [], r = null, n = null, a = null) {
    if (e == null) {
        if (!r) return null
    ...
    return o.reduceRight((h, c, y) => {
            ...
            s &&
                (l < 0 && y === 0
                    ? (Gn(
                      ...
                      (R = null))
                    : l === y &&
                      ((E = !0), (R = c.route.hydrateFallbackElement || null))))
        let x = t.concat(o.slice(0, y + 1)),
            b = () => {
                let T
                return (
                    g
        ...
        return r && (c.route.ErrorBoundary || c.route.errorElement || y === 0)
            ? f.createElement(ii, {
                  location: r.location,
...
function pt(e) {
    let t = f.useContext(Qe)
    return (V(t, br(e)), t)
}
function ci(e) {
    let t = f.useContext(xe)
    return (V(t, br(e)), t)
}
function yt(e) {
    let t = ci(e),
...
function fi() {
    return pt('useNavigation').navigation
}
function Sr() {
...
function Cr() {
    let e = pt('useActionData'),
        t = yt('useLoaderData')
    return e.actionData ? e.actionData[t] : void 0
}
function Lr() {
    let e = f.useContext(Er),
        t = pt('useRouteError'),
        r = yt('useRouteError')
    return e !== void 0 ? e : t.errors?.[r]
}
function hi() {
    let { router: e } = ui('useNavigate'),
        t = yt('useNavigate'),
        r = f.useRef(!1)
    return (
        Jn(() => {
...
var wn = {}
function Gn(e, t, r) {
    !t && !wn[e] && ((wn[e] = !0), ie(!1, r))
}
var En = {}
function sr(e, t) {
    !e && !En[t] && ((En[t] = !0), console.warn(t))
}
var mi = 'useOptimistic',
    Rn = $a[mi],
    pi = () => {}
function yi(e) {
    return Rn ? Rn(e) : [e, pi]
...
var ts = ['HydrateFallback', 'hydrateFallbackElement'],
    vi = class {
        constructor() {
            ;((this.status = 'pending'),
...
function rs({
    ...
    let [a, o] = f.useState(e.state),
        [i, s] = yi(a),
        [l, u] = f.useState(),
        [h, c] = f.useState({ isTransitioning: !1 }),
        [y, g] = f.useState(),
        [E, L] = f.useState(),
        [R, x] = f.useState(),
        b = f.useRef(new Map()),
        T = f.useCallback(
                ...
                ;(W &&
                    ...
                    Object.values(W).forEach((Z) =>
                        r(Z, {
                            ...
                            unstable_pattern: ft(m.matches),
                        }),
                    ),
                    m.fetchers.forEach((Z, q) => {
            ...
            [e.window, t, E, y, n, s, r],
        )
    ;(f.useLayoutEffect(() => e.subscribe(T), [e, T]),
        f.useEffect(() => {
            h.isTransitioning && !h.flushSync && g(new vi())
        }, [h]),
        f.useEffect(() => {
            if (y && l && e.window) {
                let m = l,
        ...
        f.useEffect(() => {
            y && l && i.location.key === l.location.key && y.resolve()
        }, [y, E, i.location, l]),
        f.useEffect(() => {
            !h.isTransitioning &&
                R &&
...
var gi = f.memo(wi)
function wi({ routes: e, future: t, state: r, unstable_onError: n }) {
    return ni(e, void 0, r, n, t)
}
function ns(e) {
    return ri(e.context)
}
function Ei({
    ...
    return (
        ie(
            E != null,
            `<Router basename="${s}"> is not able to match the URL "${u}${h}${c}" because it does not start with the basename, so the <Router> won't render anything.`,
        ),
        E == null
            ? null
            : f.createElement(
                  Re.Provider,
                  { value: l },
                  f.createElement(Ft.Provider, { children: t, value: E }),
              )
    )
}
function Ri() {
    return { params: Rr(), loaderData: xr(), actionData: Cr(), matches: Sr() }
}
function as(e) {
    return function () {
        const r = Ri()
...
function bi() {
    return { params: Rr(), loaderData: xr(), actionData: Cr() }
}
function os(e) {
    return function () {
        const r = bi()
...
function Si() {
    return { params: Rr(), loaderData: xr(), actionData: Cr(), error: Lr() }
}
function is(e) {
    return function () {
        const r = Si()
...
function Ti() {
    if (Ct === null)
        try {
            ;(new FormData(document.createElement('form'), 0), (Ct = !1))
        } catch {
            Ct = !0
        }
    return Ct
...
function _i(e, t) {
    ...
    if (Ci(e)) {
        ...
        ;((n = s ? Ee(s, t) : null),
            ...
            (a = Zt(e.getAttribute('enctype')) || _t),
            (o = new FormData(e)))
    } else if (
        xi(e) ||
        (Li(e) && (e.type === 'submit' || e.type === 'image'))
    ) {
        let s = e.form
        if (s == null)
            throw new Error(
        ...
        if (
            ((n = l ? Ee(l, t) : null),
            (r =
                e.getAttribute('formmethod') || s.getAttribute('method') || Dt),
            (a =
                Zt(e.getAttribute('formenctype')) ||
                Zt(s.getAttribute('enctype')) ||
                _t),
            (o = new FormData(s, e)),
            !Ti())
        ) {
...
function ur(e) {
    ...
    return ((t.length = r.length), Sn.call(this, n))
}
function Sn(e) {
    ...
    for (; i.length > 0; ) {
        ...
        if (Array.isArray(h))
                ...
                switch (c) {
                    ...
                    case Kn:
                        if (t[y]) u((t[l] = t[y]))
                            ...
                            const M = new qn()
                            ;((n[y] = M), u((t[l] = M.promise)))
                        }
                        continue
                    case Xn:
                        const [, x, b] = h
                        let T = b && er && er[b] ? new er[b](x) : new Error(x)
                        ;((t[l] = T), u(T))
                        continue
                    case Ji:
                        u((t[l] = t[y]))
            ...
            const c = {}
            t[l] = c
            for (const y of Object.keys(h).reverse()) {
                const g = []
                ;(i.push([
                    h[y],
                    (E) => {
...
async function Ki(e) {
    ...
    return { done: t.done, value: ur.call(this, r) }
}
async function qi(e) {
    let t = await e.read()
    for (; !t.done; ) {
...
var Zi = {
    ...
    el = /[&><\u2028\u2029]/g
function tl(e) {
    return e.replace(el, (t) => Zi[t])
}
function ge(e, t) {
    if (e === !1 || e === null || typeof e > 'u') throw new Error(t)
}
var cr = Symbol('SingleFetchRedirect'),
    Qn = class extends Error {},
    rl = 202,
    nl = new Set([100, 101, 204, 205])
...
function al(e, t, r, n, a, o = () => !0) {
    return async (i) => {
        let { request: s, matches: l, fetcherKey: u } = i,
            h = e()
        if (s.method !== 'GET') return ol(i, r, a)
        let c = l.some((y) => {
            let { hasLoader: g, hasClientLoader: E } = t(y)
            return y.shouldCallHandler() && g && !E
        })
        return !n && !c
            ? il(i, t, r, a)
            : u
...
async function ol(e, t, r) {
    ...
    return vr(o.result) || We(o.result) || lr(o.result)
        ? { [n.route.id]: o }
        : { [n.route.id]: { type: o.type, result: fo(o.result, a) } }
}
...
async function ll(e, t, r, n, a, o, i = () => !0) {
    let s = new Set(),
        l = !1,
        u = e.matches.map(() => xn()),
        h = xn(),
            ...
            e.matches.map(async (E, L) =>
                E.resolve(async (R) => {
                    ...
                    if (!E.shouldCallHandler(D)) {
                        l ||
                            (l =
                                E.shouldRevalidateArgs != null && b && M === !0)
                        return
                    }
                    if (i(E) && T) {
                        b && (l = !0)
                        try {
                            let m = await R(async () => {
                                let { data: B } = await n(e, o, [x])
                                return dt(B, x)
                            })
                            c[x] = { type: 'data', result: m }
                        } catch (m) {
                            c[x] = { type: 'error', result: m }
                        }
                        return
                    }
                    b && s.add(x)
    ...
    return (await y, await sl(h.promise, e.matches, s, c), c)
}
    ...
    try {
        ...
        a !== void 0 &&
            Array.from(r.values()).forEach((i) => {
                n[i].result instanceof Qn && (n[i].result = a)
            })
    } catch {}
}
...
async function dl(e, t, r) {
    let { request: n } = e,
        a = Zn(n.url, t, 'data')
    n.method === 'GET' &&
        ((a = cl(a)), r && a.searchParams.set('_routes', r.join(',')))
    let o = await fetch(a, await Qi(n))
    ...
    try {
        let i = await fl(o.body, window),
            s
        if (n.method === 'GET') {
            let l = i.value
            cr in l ? (s = { redirect: l[cr] }) : (s = { routes: l })
        } else {
            let l = i.value,
                u = r?.[0]
...
function dt(e, t) {
    ...
    let r = e.routes[t]
    if (r == null) throw new Qn(`No result found for routeId "${t}"`)
...
function hl(e, t, r) {
    let n = e
            .map((o) => {
                ...
                return [
                    s && s.css
                        ? s.css.map((l) => ({ rel: 'stylesheet', href: l }))
                        : [],
                    i?.links?.() || [],
                ]
            })
...
async function ml(e) {
    if (!e.css) return
    let t = ta(e)
    await Promise.all(t.map(na))
}
async function ra(e, t) {
    if ((!e.css && !t.links) || !wl()) return
    let r = []
    if (
        (e.css && r.push(...ta(e)),
...
function aa(e, t) {
    let r = new Set(),
        n = new Set(t)
    return e.reduce((a, o) => {
        if (t && !Pr(o) && o.as === 'script' && o.href && n.has(o.href))
            return a
        let s = JSON.stringify(gl(o))
...
function tr(e, t) {
    ...
    throw (
        console.error(n),
        new Ye(405, 'Method Not Allowed', new Error(n), !0)
    )
}
function Tr(e, t, r, n, a, o = '', i = oa(e), s) {
    return (i[o] || []).map((l) => {
        let u = t[l.id]
        function h(b) {
            return (
        ...
        if (u) {
            Object.assign(R, {
                ...
                handle: u.handle,
                shouldRevalidate: Ln(R.path, u, l, n, s),
            })
            let b = r && r.loaderData && l.id in r.loaderData,
                ...
                N =
                    s == null &&
                    (u.clientLoader?.hydrate === !0 || !l.hasLoader)
            ;((R.loader = async (
                { request: m, params: B, context: W, unstable_pattern: G },
                U,
            ) => {
                try {
                    return await L(
                ...
                (R.loader.hydrate = xl(l.id, u.clientLoader, l.hasLoader, a)),
                (R.action = (
                    { request: m, params: B, context: W, unstable_pattern: G },
                    U,
                ) =>
                    L(async () => {
                        ...
                        return u.clientAction({
                            ...
                            unstable_pattern: G,
                            async serverAction() {
                                return (Pt('action', l), y(U))
                            },
                        })
                    })))
        } else {
            ;(l.hasClientLoader || (R.loader = (M, D) => L(() => c(D))),
                l.hasClientAction ||
                    (R.action = (M, D) =>
                        L(() => {
                            if (a) throw tr('clientAction', l.id)
            ...
            R.lazy = {
                loader: l.hasClientLoader
                    ? async () => {
                          let { clientLoader: M } = l.clientLoaderModule
                              ...
                              : await T()
                          return (
                              ge(M, 'No `clientLoader` export found'),
                              (D, N) =>
                                  M({
                                      ...D,
                                      async serverLoader() {
                                          return (Pt('loader', l), c(N))
                                      },
                                  })
                          )
                      }
                ...
                action: l.hasClientAction
                    ? async () => {
                          let M = l.clientActionModule
                              ? import(l.clientActionModule)
                              : T()
                          E(l)
                ...
                middleware: l.hasClientMiddleware
                    ? async () => {
                          let { clientMiddleware: M } = l.clientMiddlewareModule
                              ...
                              : await T()
                          return (
                              ge(M, 'No `clientMiddleware` export found'),
                              M
                          )
                      }
                    : void 0,
        ...
        let x = Tr(e, t, r, n, a, l.id, i, s)
        return (x.length > 0 && (R.children = x), R)
    })
}
function Ln(e, t, r, n, a) {
    if (a) return bl(r.id, t.shouldRevalidate, a)
    if (!n && r.hasLoader && !r.hasClientLoader) {
        let o = e ? An(e)[1].map((s) => s.paramName) : []
...
function cs(e, t, r, n, a, o) {
    f.useEffect(() => {
        if (!Dr(a, n) || window.navigator?.connection?.saveData === !0) return
        function i(h) {
            let c =
                h.tagName === 'FORM'
        ...
        async function s() {
            document
                ...
                .forEach(i)
            let h = Array.from(Ot.keys()).filter((c) =>
                Nt.has(c) ? (Ot.delete(c), !1) : !0,
            )
            if (h.length !== 0)
                try {
                    await la(
...
async function la(e, t, r, n, a, o, i, s, l, u) {
    const h = new URLSearchParams()
    ;(h.set('paths', e.sort().join(',')), h.set('version', r.version))
    let c = new URL(Ml(s, i), window.location.origin)
    if (((c.search = h.toString()), c.toString().length > Ll)) {
        Ot.clear()
        return
    }
    let y
    try {
        let R = await fetch(c, { signal: u })
        if (R.ok) {
    ...
    let g = new Set(Object.keys(r.routes)),
        E = Object.values(y).reduce(
            (R, x) => (x && !g.has(x.id) && (R[x.id] = x), R),
            {},
        )
    ;(Object.assign(r.routes, E), e.forEach((R) => Tl(R, Nt)))
    let L = new Set()
    ;(Object.values(E).forEach((R) => {
        R && (!R.parentId || !E[R.parentId]) && L.add(R.parentId)
    }),
        L.forEach((R) => l(R || null, Tr(E, n, null, a, o, R))))
}
function Tl(e, t) {
    if (t.size >= Cl) {
...
var Pn = 'data-react-router-critical-css'
function ds({ nonce: e }) {
    let { isSpaMode: t, manifest: r, routeModules: n, criticalCss: a } = Ze(),
        { errors: o, matches: i } = Ht(),
        s = Or(i, o, t),
        l = f.useMemo(() => hl(s, n, r), [s, n, r])
    return f.createElement(
        f.Fragment,
        null,
        typeof a == 'string'
        ...
        l.map(({ key: u, link: h }) =>
            Pr(h)
                ? f.createElement(sa, { key: u, nonce: e, ...h })
...
function sa({ page: e, ...t }) {
    let { router: r } = _r(),
        n = f.useMemo(
            () => Ae(r.routes, e, r.basename),
            [r.routes, e, r.basename],
        )
    return n ? f.createElement(Al, { page: e, matches: n, ...t }) : null
}
function Ol(e) {
...
function Al({ page: e, matches: t, ...r }) {
    let n = Me(),
        { manifest: a, routeModules: o } = Ze(),
        { basename: i } = _r(),
        { loaderData: s, matches: l } = Ht(),
        u = f.useMemo(() => Cn(e, t, l, a, n, 'data'), [e, t, l, a, n]),
        h = f.useMemo(() => Cn(e, t, l, a, n, 'assets'), [e, t, l, a, n]),
        c = f.useMemo(() => {
            ...
            if (
                (t.forEach((x) => {
                    let b = a.routes[x.route.id]
                    !b ||
                        !b.hasLoader ||
                        ((!u.some((T) => T.route.id === x.route.id) &&
                            x.route.id in s &&
                            o[x.route.id]?.shouldRevalidate) ||
                        b.hasClientLoader
                            ? (L = !0)
                            : E.add(x.route.id))
                }),
    ...
    return f.createElement(
        ...
        l.flat().map((c) => {
            ...
            if ('script:ld+json' in c)
                try {
                    let y = JSON.stringify(c['script:ld+json'])
                    return f.createElement('script', {
                        key: `script:ld+json:${y}`,
                        type: 'application/ld+json',
                        dangerouslySetInnerHTML: { __html: tl(y) },
                    })
                } catch {
                    return null
                }
...
function Il(e) {
    let {
        ...
        { router: s, static: l, staticContext: u } = _r(),
        { matches: h } = Ht(),
        c = Ko(),
        y = Dr(o, i)
...
${g.map((M, D) => {
    let N = `route${D}`,
        m = t.routes[M.route.id]
    ge(m, `Route ${M.route.id} not found in manifest`)
    let {
        ...
        Z = [
            ...(B ? [{ module: B, varName: `${N}_clientAction` }] : []),
            ...(W ? [{ module: W, varName: `${N}_clientLoader` }] : []),
            ...(G ? [{ module: G, varName: `${N}_clientMiddleware` }] : []),
            ...(U ? [{ module: U, varName: `${N}_HydrateFallback` }] : []),
            { module: se, varName: `${N}_main` },
        ]
    if (Z.length === 1) return `import * as ${N} from ${JSON.stringify(se)};`
    let q = Z.map((te) => `import * as ${te.varName} from "${te.module}";`)
            .join(`
`),
        ne = `const ${N} = {${Z.map((te) => `...${te.varName}`).join(',')}};`
    return [q, ne].join(`
`)
}).join(`
`)}
            ...
            It || c
                ...
                : $l(
                      t.entry.imports.concat(
                          Mr(g, t, { includeHydrateFallback: !0 }),
                      ),
                  ),
...
var hs = class extends f.Component {
    constructor(e) {
        ;(super(e),
...
function ua({ error: e, isOutsideRemixApp: t }) {
    console.error(e)
...
function dr({ title: e, renderScripts: t, isOutsideRemixApp: r, children: n }) {
        ...
        : f.createElement(
              ...
              f.createElement(
                  ...
                  f.createElement(
                      ...
                      n,
                      t ? f.createElement(Il, null) : null,
                  ),
              ),
          )
}
...
try {
    ca && (window.__reactRouterVersion = '7.10.1')
} catch {}
var da = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
    fa = f.forwardRef(function (
        {
            onClick: t,
            discover: r = 'render',
            prefetch: n = 'none',
        ...
        let { basename: E, unstable_useTransitions: L } = f.useContext(Re),
            R = typeof u == 'string' && da.test(u),
            x,
            b = !1
        if (typeof u == 'string' && R && ((x = u), ca))
            try {
                let G = new URL(window.location.href),
                    U = u.startsWith('//')
                        ? new URL(G.protocol + u)
                        : new URL(u),
                    se = Ee(U.pathname, E)
                U.origin === G.origin && se != null
                    ? (u = se + U.search + U.hash)
                    : (b = !0)
            } catch {
                ie(
                    !1,
        ...
        return M && !R
            ? f.createElement(
                  ...
                  null,
                  W,
                  f.createElement(sa, { page: T }),
              )
            : W
    })
fa.displayName = 'Link'
var jl = f.forwardRef(function (
    {
        'aria-current': t = 'page',
        caseSensitive: r = !1,
        className: n = '',
    ...
    let c = mt(i, { relative: u.relative }),
        y = Me(),
        g = f.useContext(Qe),
        { navigator: E, basename: L } = f.useContext(Re),
        R = g != null && Kl(c) && s === !0,
        x = E.encodeLocation ? E.encodeLocation(c).pathname : c.pathname,
        b = y.pathname,
        T =
    ...
    ;(r ||
        ...
        (x = x.toLowerCase())),
        T && L && (T = Ee(T, L) || T))
    const M = x !== '/' && x.endsWith('/') ? x.length - 1 : x.length
    let D = b === x || (!a && b.startsWith(x) && b.charAt(M) === '/'),
        N =
            T != null &&
            (T === x || (!a && T.startsWith(x) && T.charAt(x.length) === '/')),
        m = { isActive: D, isPending: N, isTransitioning: R },
        B = D ? t : void 0,
        W
    typeof n == 'function'
        ? (W = n(m))
...
var Hl = f.forwardRef(
    (
        ...
        let { unstable_useTransitions: E } = f.useContext(Re),
            L = Vl(),
            R = Jl(s, { relative: u }),
            x = i.toLowerCase() === 'get' ? 'get' : 'post',
            b = typeof s == 'string' && da.test(s),
            T = (M) => {
                if ((l && l(M), M.defaultPrevented)) return
                M.preventDefault()
                let D = M.nativeEvent.submitter,
                    N = D?.getAttribute('formmethod') || i,
                    m = () =>
                        L(D || M.currentTarget, {
                            fetcherKey: t,
                            method: N,
...
Hl.displayName = 'Form'
function Ul({ getKey: e, storageKey: t, ...r }) {
    let n = f.useContext(Ut),
        { basename: a } = f.useContext(Re),
        o = Me(),
        i = Sr()
    ...
    let l = ((u, h) => {
        ...
        try {
            let y = JSON.parse(sessionStorage.getItem(u) || '{}')[
    ...
    return f.createElement('script', {
        ...
        suppressHydrationWarning: !0,
        dangerouslySetInnerHTML: {
            __html: `(${l})(${JSON.stringify(t || fr)}, ${JSON.stringify(s)})`,
        },
    })
}
Ul.displayName = 'ScrollRestoration'
function ha(e) {
    return `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`
}
function Ar(e) {
...
var Wl = 0,
    Yl = () => `__${String(++Wl)}__`
function Vl() {
    let { router: e } = Ar('useSubmit'),
        { basename: t } = f.useContext(Re),
        r = di(),
        n = e.fetch,
        a = e.navigate
    return f.useCallback(
        async (o, i = {}) => {
            ...
            if (i.navigate === !1) {
                let y = i.fetcherKey || Yl()
                await n(y, r, i.action || s, {
...
function Jl(e, { relative: t } = {}) {
    let { basename: r } = f.useContext(Re),
        n = f.useContext(xe)
    ...
    if (e == null) {
        ...
        if (l.some((h) => h === '')) {
            ;(s.delete('index'),
                l.filter((c) => c).forEach((c) => s.append('index', c)))
            let h = s.toString()
            o.search = h ? `?${h}` : ''
        }
    }
    return (
        (!e || e === '.') &&
            ...
            (o.search = o.search
                ...
                : '?index'),
        r !== '/' &&
            (o.pathname = o.pathname === '/' ? r : Le([r, o.pathname])),
        Pe(o)
    )
}
var fr = 'react-router-scroll-positions',
    Mt = {}
function hr(e, t, r, n) {
    let a = null
    return (
        n &&
            (r !== '/'
                ? (a = n(
                      { ...e, pathname: Ee(e.pathname, r) || e.pathname },
                      t,
                  ))
                : (a = n(e, t))),
        a == null && (a = e.key),
...
function Gl({ getKey: e, storageKey: t } = {}) {
    let { router: r } = Ar('useScrollRestoration'),
        { restoreScrollPosition: n, preventScrollReset: a } = zl(
            'useScrollRestoration',
        ),
        { basename: o } = f.useContext(Re),
        i = Me(),
        s = Sr(),
        l = fi()
    ;(f.useEffect(
        ...
        Xl(
            f.useCallback(() => {
                ...
                try {
                    sessionStorage.setItem(t || fr, JSON.stringify(Mt))
                } catch (u) {
                    ie(
                        !1,
        ...
        typeof document < 'u' &&
            (f.useLayoutEffect(() => {
                try {
                    let u = sessionStorage.getItem(t || fr)
                    u && (Mt = JSON.parse(u))
                } catch {}
            }, [t]),
            f.useLayoutEffect(() => {
...
function Kl(e, { relative: t } = {}) {
    let r = f.useContext(wr)
    V(
        r != null,
        "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?",
    )
    let { basename: n } = Ar('useViewTransitionState'),
        a = mt(e, { relative: t })
