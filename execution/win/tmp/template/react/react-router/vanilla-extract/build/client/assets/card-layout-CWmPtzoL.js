import { p as r } from './chunk-EPOLDU6W-CyFp4JB8.js'
import { c as h, H as m } from './ja-BCf0BCoW.js'
import { B as l } from './box-C4eT95C-.js'
var u = 'qvv26x0'
function x(e) {
    if (typeof e != 'object') throw Error('runtime error')
    const { className: t, style: i, children: s } = e
    return r.jsx('p', { className: `${u} ${t}`, style: i, children: s })
}
...
function y(e) {
    ...
    return r.jsxs('section', {
        children: [
            r.jsx(m, { children: r.jsx(x, { children: i }) }),
            r.jsx(j, {
...
function B({ characters: e, title: t }) {
    return e.isErr
