    ...
    /******/ var __webpack_modules__ = {
        ...
        /***/ 184: /***/ function (
            ...
            async function main(TARGET_DIR_IN_ZIP) {
                ...
                const extractedRoot = (0, node_path_1.join)(
                    extractDir,
                    rootFolder
                );
                const sourceDir = (0, node_path_1.join)(
                    extractedRoot,
                    TARGET_DIR_IN_ZIP
                );
                if (!(0, node_fs_1.existsSync)(sourceDir)) {
                    throw new Error(
                        `❌ target directory not found in zip: ${sourceDir}`
                    );
                }
