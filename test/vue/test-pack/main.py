...
def get_path():
    ...
    if os_name == "Windows":
        return os.path.join(repo_root, "execution", "win", "tmp", "index.js")
    else:
        return os.path.join(repo_root, "execution", "mac", "tmp", "index.js")
def run() -> None:
    cli_entry = get_path()

    ACTIONS = [
        {
            "projectName": "vue-router-tailwind",
            "techStack": KEYBOARD["ArrowDown"] + KEYBOARD["Enter"],
            "framework": KEYBOARD["Enter"],
            "css": KEYBOARD["Enter"],
            #"library": KEYBOARD["Space"] + KEYBOARD["ArrowDown"]+ KEYBOARD["Space"] + KEYBOARD["Enter"],
        },{
            "projectName": "vue-router-vanilla-extract",
            "techStack": KEYBOARD["ArrowDown"] + KEYBOARD["Enter"],
            "framework": KEYBOARD["Enter"],
        ...
        {
            "projectName": "nuxt-tailwind",
            "techStack": KEYBOARD["ArrowDown"] + KEYBOARD["Enter"],
            "framework": KEYBOARD["ArrowDown"] + KEYBOARD["Enter"],
            "css": KEYBOARD["Enter"],
            #"library": KEYBOARD["Space"] + KEYBOARD["ArrowDown"] + KEYBOARD["Space"] + KEYBOARD["Enter"],
        },{
            "projectName": "nuxt-vanilla-extract",
            "techStack": KEYBOARD["ArrowDown"] + KEYBOARD["Enter"],
            "framework": KEYBOARD["ArrowDown"] + KEYBOARD["Enter"],
            "css": KEYBOARD["ArrowDown"] + KEYBOARD["Enter"],
            #"library": KEYBOARD["Space"] + KEYBOARD["ArrowDown"] + KEYBOARD["Space"] + KEYBOARD["Enter"],
